...
-- vim.keymap.set('n', '<Esc>', '<cmd>nohlsearch<CR>') -- in case hlsearch is false
...
-- Map the Rfinder command to <leader>e only on macOS
...
require('lazy').setup {
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, 'Normal', { bg = '#00000a' })
